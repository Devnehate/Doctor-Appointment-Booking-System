...
const Profile = ({doctorData}) => {
    ...
    const handlReusableInputChangeFunc = (key, index, event) => {
    ...
    const handleQualificationChange = (event, index) => {
        handlReusableInputChangeFunc('qualifications', index, event)
    };
    ...
    const addExperience = e => {
        ...
        addItem('experiences', {
            startingDate:"",endingDate:"",position:"Senior Surgeon",hospital:"Dhaka Medical College",
        });
    };

    const handleExperienceChange = (event, index) => {
        handlReusableInputChangeFunc('experiences', index, event)
    };
    ...
    const addTimeSlot = e => {
        ...
        addItem('timeSlots', { day: "Monday", startingTime: "10:00", endingTime: "04:30" });
    };

    const handleTimeSlotChange = (event, index) => {
        handlReusableInputChangeFunc('timeSlots', index, event)
    };
      ...
      <div>
          ...
          <form>
              ...
              <div className='mb-5'>
                  ...
                  <input type="text" name='email' value={FormData.email} onChange={handleInputChange} placeholder='Email' className='form_input' readOnly aria-readonly disabled='true' />
              </div>
              <div className='mb-5'>
                  <p className='form_label'>Phone*</p>
                  <input type="text" name='phone' value={FormData.email} onChange={handleInputChange} placeholder='Phone Number' className='form_input' />
              </div>
              <div className='mb-5'>
                  ...
                  {formData.experiences ?.map((item, index) =>(
                      <div key={index}>
                          <div>
                              ...
                              <div className='grid grid-cols-2 mt-3 gap-5'>
                                  <div>
                                      <p className='form_label'>Posotion*</p>
              ...
              { formData.photo && (
                ...
                <div className='relative w-[130px] h-[50px]'>
                  ...
                  <label htmlFor="customFile" className='absolute top-0 left-0 w-full h-full flex items-center px-[1rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor truncate rounded-lg font-semibold cursor-pointer'>Upload Photo</label>
                </div>
              </div>
              <div className="mt-7 flex justify-center">
                  <button type='submit' onClick={updateProfileHandler} className='bg-primaryColor text-white text-[18px] leading-[30px] w-[80%] py-3 px-4 rounded-lg'>Update Profile</button>
              </div>
          </form>
    </div>
  )
